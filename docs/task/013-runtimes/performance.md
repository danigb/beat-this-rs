...
### short.wav — 9.3s audio, 468 mel frames, 1 chunk
...
### 01 Mañana.mp3 — 4.5 min, 13602 mel frames, 10 chunks
...
### 02 Burros Pintados.mp3 — 3.4 min, 10144 mel frames, 7 chunks
...
|------|-----|------|------------|
| short.wav (1 chunk) | 0.364s | 0.387s | 1.06x (6% slower) |
| Mañana (10 chunks) | 3.371s | 3.775s | 1.12x (12% slower) |
| Burros (7 chunks) | 2.369s | 2.632s | 1.11x (11% slower) |
...
|------|-----|------|---------|
| short.wav | 0.008s | 0.003s | 2.7x |
| Mañana | 0.193s | 0.091s | 2.1x |
| Burros | 0.147s | 0.066s | 2.2x |
...
|------|-----|------|--------|
| short.wav | 0.782s | **0.423s** | rten (1.8x) |
| Mañana | 4.295s | **4.245s** | rten (1.01x) |
| Burros | 3.173s | **2.990s** | rten (1.06x) |
